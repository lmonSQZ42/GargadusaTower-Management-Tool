                    ...
                    if (member) {
                      ...
                      return (
                        <div
                          ...
                          className={`border border-dashed transition-all rounded p-1.5 text-[10px] flex items-center justify-center space-x-1 select-none ${customBorder}`}
                        >
                          <span>{label}</span>
                        </div>
                      );
      ...
      <div className="lg:col-span-4 2xl:col-span-3 bg-[#0a0a0a] border border-white/10 rounded-lg p-3.5 space-y-4 shadow-sm lg:sticky lg:top-[110px] self-start">
        ...
        <div className="space-y-1 pb-1.5 border-b border-white/5">
          ...
          <p className="text-[10px] text-slate-400 leading-relaxed">
            Drag card into slot, or <span className="text-indigo-300 font-bold">Double-Click</span> card to auto-add to the active party.
          </p>
        </div>
            ...
            filteredExplorers.map((explorer) => {
              return (
                <div
                  ...
                  onDoubleClick={() => handleQuickAssign(explorer.id)}
                  className="bg-black/40 hover:bg-white/5 border border-white/5 hover:border-white/12 rounded p-2.5 transition-all cursor-grab active:cursor-grabbing flex items-center justify-between relative group select-none shadow-sm hover:ring-1 hover:ring-indigo-500/30"
                  title="Double-click to enlist instantly to selected unit"
                >
